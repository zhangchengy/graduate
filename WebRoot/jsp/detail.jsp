...
<table id="goods_table"  cellpadding="0" cellspacing="0">
  <tr >
    <td rowspan="6" width="60%" ><img src="" id="goods_image"></td>
  ...
  <tr>
	...
	<div id="image_say">
		<table class="hot_sale">
			<tr><td class="hot_sale_lan">热销商品</td></tr>
			<tr><td class="hot_goods1">1</td></tr>
			<tr><td class="hot_goods2">2</td></tr>
			<tr><td class="hot_goods3">3</td></tr>
			<tr><td class="hot_goods4">4</td></tr>
			<tr><td class="hot_goods5">5</td></tr>
		<table>
